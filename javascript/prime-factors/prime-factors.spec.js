...
describe('primeFactors', function() {
  ...
  it('factors 4294967295', function () {
    expect(primeFactors.for(4294967295)).toEqual([3, 5, 17, 257, 65537])
  });

  it('factors 429496729', function () {
    expect(primeFactors.for(429496729)).toEqual([19, 22605091]);
  });

  it('factors 22605091', function () {
    expect(primeFactors.for(22605091)).toEqual([22605091]);
  });
});
