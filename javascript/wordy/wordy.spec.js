...
describe('Word Problem', function() {
  ...
  it('ignore typical order of operations', function() {
    var question = 'What is 3 plus 2 multiplied by 3?';
    expect(new WordProblem(question).answer()).toEqual(15);
  });

  it('to the power of', function() {
    var question = 'What is 2 raised to the 5th power?';
